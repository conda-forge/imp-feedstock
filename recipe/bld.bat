...
cmake -DUSE_PYTHON2=off ^
      ...
      -DCMAKE_CXX_FLAGS="/DBOOST_ALL_DYN_LINK /EHsc /D_HDF5USEDLL_ /DH5_BUILT_AS_DYNAMIC_LIB /DPROTOBUF_USE_DLLS /DWIN32 /DGSL_DLL /DMSMPI_NO_DEPRECATE_20 /bigobj /DBOOST_ZLIB_BINARY=kernel32 /std:c++17" ^
      %PERCPPCOMP% -G Ninja ..
if errorlevel 1 exit 1
